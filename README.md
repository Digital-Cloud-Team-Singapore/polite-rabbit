...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5ffbd41c778aa7001596af53
...
To start editing your site, you can use the Sanity interface at https://polite-rabbit-bd41c.sanity.studio/.
...
Generated at `2021-01-11T05:55:49.572Z` by Stackbit version `0.3.42`.